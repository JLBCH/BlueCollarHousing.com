-- BlueCollarHousing · 0024_public_payment_room
-- The public view omitted payment_methods and room_details, so the listing page
-- couldn't show a residential listing's "Payment methods" or a Private Room's
-- household type / shared spaces. Both are meant to be public. Expose them.
